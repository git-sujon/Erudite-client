        ...
        <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 gap-8 text-center lg:grid-cols-2 lg:text-left">
              <div>
                ...
                >
                  ...
                  {
                    catagories.map(category => <p key={category.id} className='"text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75'><Link to={`/catagories/${category.catagories_id}`}>{category.Category_Name}</Link></p>)
          ...
          <div className="mt-16 border-t border-gray-100 pt-8 dark:border-gray-800">
            <p className="text-center text-xs leading-relaxed text-gray-500 dark:text-gray-400">
              © Sujon 2022. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
